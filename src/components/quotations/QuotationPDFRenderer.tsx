    ...
    <Document>
        ...
        <View style={styles.detailsContainer}>
          ...
          <View style={styles.column}>
            ...
            <View style={styles.detailRow}>
              ...
              <Text style={styles.detailValue}>{new Date(quotation.event_date).toLocaleDateString()}</Text>
            </View>
            <View style={styles.detailRow}>
            ...
            {details.days.map((day: any, dayIndex: number) => (
              <View key={dayIndex}>
                ...
                {day.cinematographers > 0 && (
                  <View style={styles.tableRow}>
                    <Text style={[styles.tableCellLeft, { flex: 2 }]}>  • Cinematographers</Text>
                    <Text style={[styles.tableCellCenter, { flex: 1 }]}>{day.cinematographers}</Text>
                    <Text style={[styles.tableCellLeft, { flex: 2.5 }]}>Professional Videography Coverage</Text>
                  </View>
                )}
                {day.drone > 0 && (
                  <View style={styles.tableRow}>
          ...
          <View style={styles.table}>
            ...
            {details.addOns.map((addOn: any, index: number) => (
              <View key={index} style={styles.tableRow}>
                ...
                <Text style={[styles.tableCellLeft, { flex: 2.5 }]}>Premium add-on service</Text>
              </View>
            ))}
          </View>
        )}
      ...
      <Page size="A4" style={styles.secondPage}>
        ...
        <View style={styles.termsSection}>
          ...
          <Text style={styles.termItem}>• This quotation is valid until the date mentioned above</Text>
          <Text style={styles.termItem}>• 50% advance payment required to confirm booking</Text>
          <Text style={styles.termItem}>• Balance payment due before/on the event date</Text>
          <Text style={styles.termItem}>• All edited photos and videos will be delivered within 30 days</Text>
        </View>
