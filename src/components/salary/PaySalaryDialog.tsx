  ...
  const handlePaySalary = async () => {
    ...
    try {
      ...
      setTimeout(() => {
        ...
        // Send salary payment notification using new WhatsApp notification system
          ...
          try {
            const notificationResponse = await supabase.functions.invoke('send-staff-notification', {
              body: {
                ...
                firmId: currentFirmId, // CRITICAL: Pass firmId for firm-specific WhatsApp
            ...
            console.error('Error in salary notification:', error);
          }
        };
