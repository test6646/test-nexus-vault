...
const StatCard = ({ 
  ...
  return (
    <Card className="flex-1 aspect-square sm:aspect-auto sm:min-h-[80px] md:min-h-[120px] flex flex-col items-center justify-center bg-white border-2 border-primary/30 rounded-full shadow-sm hover:shadow-md transition-all duration-300">
      ...
      <CardContent className="flex flex-col items-center justify-center pt-0 pb-1 sm:pb-1 md:pb-2 px-1 sm:px-2 md:px-3 space-y-0">
        ...
        {paymentBreakdown && (
          <div className="hidden md:flex items-center gap-1 text-[7px] md:text-[8px] text-muted-foreground mt-1">
