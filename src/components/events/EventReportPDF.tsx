        ...
        case 'crew_incomplete':
          ...
          return (
            <View key={event.id} style={[sharedStyles.tableRow, index % 2 === 0 && sharedStyles.tableRowAlt]}>
              ...
              <Text style={[sharedStyles.tableCell, { width: headers[1].width }]}>{formatDate(new Date(event.event_date))}</Text>
              <Text style={[sharedStyles.tableCell, { width: headers[2].width }]}>{event.client?.name || 'N/A'}</Text>
              
              {/* Required Column with breakdown */}
              <View style={[sharedStyles.tableCellAmount, { width: headers[3].width }]}>
              ...
              <View style={[sharedStyles.tableCellAmount, { width: headers[4].width }]}>
              ...
              <View style={[sharedStyles.tableCellAmount, { width: headers[5].width }]}>
        ...
        default:
          return (
            <View key={event.id} style={[sharedStyles.tableRow, index % 2 === 0 && sharedStyles.tableRowAlt]}>
              ...
              <Text style={[sharedStyles.tableCell, { width: headers[1].width }]}>{formatDate(new Date(event.event_date))}</Text>
              <Text style={[sharedStyles.tableCell, { width: headers[2].width }]}>{event.client?.name || 'N/A'}</Text>
              <Text style={[sharedStyles.tableCellAmount, { width: headers[3].width }]}>₹{(event.total_amount || 0).toLocaleString()}</Text>
              <Text style={[sharedStyles.tableCellAmount, { width: headers[4].width }]}>₹{paid.toLocaleString()}</Text>
              <Text style={[sharedStyles.tableCellAmount, { width: headers[5].width }]}>₹{balance.toLocaleString()}</Text>
            </View>
          );
      }
    }
