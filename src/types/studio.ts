...
export type TaskStatus = 'Pending' | 'In Progress' | 'Completed' | 'On Hold' | 'Waiting for Response' | 'Accepted' | 'Declined';
...
export const convertDbTaskToTask = (dbTask: TaskFromDB): Task => {
  return {
    ...
    assigned_staff: (dbTask as any).assignee || null  // Map assignee from DB to assigned_staff for UI
  };
};
